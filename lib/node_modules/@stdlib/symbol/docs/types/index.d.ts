...
import SplitSymbol = require( '@stdlib/symbol/split' );
...
interface Namespace {
	...
	* ## Notes
	*
	* -   This symbol specifies the method that splits a string at the indices that match a regular expression.
	* -   The symbol is only supported in ES6/ES2015+ environments. For non-supporting environments, the value is `null`.
	*/
	SplitSymbol: typeof SplitSymbol;
}
